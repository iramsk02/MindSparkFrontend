...
// import { Menu, X, Home,Users, BookOpen, UserPlus,LogIn } from "lucide-react"; // lucide-react for icons
...
//       <a href="/Signup" className="hover:text-white transition flex items-center gap-1">
//         <UserPlus size={18} />
//         <span>Sign Up</span>
//       </a>
//       <a href="/Signin" className="hover:text-white transition flex items-center gap-1">
//         <LogIn size={18} />
//         <span>Sign In</span>
//       </a>
//     </div>
...
//       <a href="/Signup" className="hover:text-white transition flex items-center gap-2 py-2">
//         <UserPlus size={18} />
//         <span>Sign Up</span>
//       </a>
//       <a href="/Signin" className="hover:text-white transition flex items-center gap-2 py-2">
//         <LogIn size={18} />
//         <span>Sign In</span>
//       </a>
//     </div>
...
//         </div>
//         <div className="md:w-1/2 flex justify-center items-center mb-15">
//           <img src="src\assets\Courseimg.png" alt="Course" className="w-120 rounded-2xl shadow-lg" />
//         </div>
//       </section>
